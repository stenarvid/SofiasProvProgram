	...
	constructor(options, getStoreConfig) {
		...
		this.update = (newOptions) => {
			...
			if (this.options.routeTree !== this.routeTree) {
				...
				if (process.env.NODE_ENV !== "development" && (isServer ?? this.isServer) && globalThis.__TSR_CACHE__ && globalThis.__TSR_CACHE__.routeTree === this.routeTree) processRouteTreeResult = globalThis.__TSR_CACHE__.processRouteTreeResult;
				else {
