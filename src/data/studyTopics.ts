...
import type { LessonGuidance } from "./studyGuidance";
      ...
      pages: [
        {
          ...
          id: "react-p4",
          title: "Knappar, events och vanliga React-fel",
      ...
      pages: [
        {
          ...
          id: "router-p3",
          title: "Dynamiska routes och useParams",
      ...
      pages: [
        {
          ...
          bullets: ["atom(startvärde) skapar en atomdefinition.", "Definitionen hålls stabil, här utanför komponenten.", "Samma atom och store ger delat state."],
          ...
          bullets: ["För en skrivbar atom returneras värde och setter.", "Samma atom i samma store ger delat state.", "Komponenter som läser värdet kan uppdateras när det ändras."],
    ...
    },
{
      ...
      pages: [
        {
          id: "typescript-p1",
          title: "Grundtyper och statisk typkontroll",
